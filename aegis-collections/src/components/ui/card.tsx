...
const Card = forwardRef<HTMLDivElement, CardHTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "rounded-xl border border-border bg-[hsl(var(--bg-elevated))] text-[hsl(var(--text-primary))] shadow-sm",
        className
      )}
      {...props}
    />
...
const CardTitle = forwardRef<HTMLParagraphElement, CardHTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <p
      ref={ref}
...
const CardDescription = forwardRef<HTMLParagraphElement, CardHTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <p
      ref={ref}
